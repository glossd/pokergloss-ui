            ...
            >
              {
                props =>
                  <animated.div style={props}>
                    <GoldButton className={classes.button}>
                      <a target="_blank" href={"https://info.pokergloss.com"}>{t("Landing.info")} poker<span
                        style={{color: "#61dafb"}}>gloss</span></a>
                    </GoldButton>
                  </animated.div>
              }
            </Spring>
